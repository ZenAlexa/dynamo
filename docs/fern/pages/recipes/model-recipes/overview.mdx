...
<div className="dynamo-model-grid" data-recipe-card-grid>
  <div className="dynamo-model-card" data-recipe-card data-provider="nvidia" data-runtime="trtllm" data-hardware="b200 gb200 h200" data-technique="aggregated kv-routing spec-decoding" data-workload="agentic-coding long-context-reuse multimodal-reuse">
  ...
  <a className="dynamo-card-link" href="gemma4-31b.mdx" aria-label="Open the Gemma 4 31B recipe">Open recipe</a>
  </div>
