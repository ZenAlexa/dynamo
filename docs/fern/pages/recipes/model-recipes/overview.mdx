...
<div className="dynamo-model-grid" data-recipe-card-grid>
  ...
  <div className="dynamo-model-card" data-recipe-card data-provider="moonshot" data-runtime="vllm sglang" data-hardware="gb200 gb300" data-technique="aggregated disaggregated kv-routing spec-decoding" data-workload="agentic-coding">
    <div className="dynamo-model-card-top">
    ...
    <p className="dynamo-model-summary">Kimi-K3 recipes for vLLM on GB200 and GB300, plus SGLang aggregated serving with DSPARK on GB300.</p>
    <div className="dynamo-model-tags"><span>vLLM · SGLang</span><span>GB200 · GB300</span><span>Day-0</span></div>
